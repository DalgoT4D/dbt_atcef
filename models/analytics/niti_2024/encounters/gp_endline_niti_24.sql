     -- contains information from the encounters staging table filtered for "Gram Panchayat Endline"
   
  {{ config(
    materialized='table',
    tags=["analytics", "analytics_niti_2024", "analytics_intermediate", "encounters_niti_2024"]
  ) }}
  ...
  FROM {{ ref('encounter_type_niti_24') }} e
