...
-- ANALYTICAL TABLE: Work Orders × Farmers × Machines × Silt (gdgs 2024)
--
-- ------------------------------------------------------------
...
--    SOURCES:
--      - work_order_farmer_gdgs_24
--      - machine_regn_gdgs_24
--      - approval_status_gdgs_24
--
...
--      - work_order_machine_gdgs_24
--      - machine_regn_gdgs_24
--      - machine_endline_linelist_gdgs_24
--
...
--   - farmer_silt_cl
--   - gp_silt
--   - workorder_endline_linelist_gdgs_24
--   - machine_silt
...
wf.machine_sub_id,
mr.machine_type
from {{ ref('work_order_farmer_gdgs_24') }} as wf
LEFT JOIN {{ref('machine_regn_gdgs_24')}} as mr
ON mr.subject_id = wf.machine_sub_id
INNER JOIN {{ ref('approval_status_gdgs_24') }} as a 
...
FROM {{ ref('work_order_machine_gdgs_24') }} as mw
INNER JOIN {{ ref('approval_status_gdgs_24') }} as a 
...
LEFT JOIN {{ ref('machine_endline_linelist_gdgs_24') }} me
...
approved_work_orders AS (
    ...
    FROM {{ ref('work_order_regn_gdgs_24') }} AS w
...
-- LEFT JOIN {{ref('workorder_endline_linelist_gdgs_24')}} AS we ON wd.workorderid = we.workorder_id
