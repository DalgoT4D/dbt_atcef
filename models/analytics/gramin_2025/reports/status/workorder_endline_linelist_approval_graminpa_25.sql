-- Keeps the latest work_order_endline_graminpa_25 per work order and
...
WITH latest_records AS (
    ...
    FROM {{ ref('work_order_endline_graminpa_25') }} as we
...
LEFT JOIN {{ ref('work_order_regn_graminpa_25') }} AS ws
