-- Rolls up active_workorder_linelist_graminpa_26 by stakeholder and work order to total silt, farmer, and machine metrics along with active days.
{{ config(
  materialized='table',
...
from  {{ref('active_work_order_graminpa_26')}} as aw
group by 
    aw.stakeholder_responsible,
    aw.workorderid,
    aw.workorder_name,
