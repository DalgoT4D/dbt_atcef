-- Keeps the latest work_order_endline_graminpa_26 per work order and
...
WITH latest_records AS (
    ...
    FROM {{ ref('work_order_endline_graminpa_26') }} as we
...
LEFT JOIN {{ ref('work_order_regn_graminpa_26') }} AS ws
