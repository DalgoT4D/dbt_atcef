-- Keeps the latest farmer_endline_graminpa_26 per farmer, adds registration fields, 
...
WITH farmer_latest_records AS (
    ...
    FROM {{ ref('farmer_endline_graminpa_26') }} AS t1 
...
farmer_with_status AS (
    ...
    LEFT JOIN {{ ref('approval_status_graminpa_26') }} AS asn
