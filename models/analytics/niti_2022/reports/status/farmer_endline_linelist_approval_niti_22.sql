-- Keeps the latest farmer_endline_niti_22 per farmer, adds registration fields, 
...
WITH farmer_latest_records AS (
    ...
    FROM {{ ref('farmer_endline_niti_22') }} AS t1 
...
farmer_with_status AS (
    ...
    LEFT JOIN {{ ref('approval_status_niti_22') }} AS asn
...
LEFT JOIN {{ ref('farmer_regn_niti_22') }} AS fr
