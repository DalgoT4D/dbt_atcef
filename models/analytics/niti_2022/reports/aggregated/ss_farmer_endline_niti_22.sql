-- Farmer endline status for NITI 2022 using approved registrations and
...
FROM {{ ref('farmer_regn_niti_22') }} AS fr
LEFT JOIN {{ ref('farmer_endline_linelist_niti_22') }} AS fe
