-- Aggregated farmer status by location for NITI 2022 using analytics lineage.
{{ config(
  materialized='table',
...
SELECT
    ...
    COUNT(CASE WHEN farmer_category = 'Semi-medium (5-9.99 acres)' THEN 1 END) AS semi_medium,
