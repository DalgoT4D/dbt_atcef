-- Keeps the latest farmer_endline_niti_23 per farmer, adds registration fields, 
...
WITH farmer_latest_records AS (
    ...
    FROM {{ ref('farmer_endline_niti_23') }} AS t1 
...
farmer_with_status AS (
    ...
    LEFT JOIN {{ ref('approval_status_niti_23') }} AS asn
...
LEFT JOIN {{ ref('farmer_regn_niti_23') }} AS fr
