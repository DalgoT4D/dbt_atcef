-- Lists machine encounters by joining work_order_machine_niti_23 to machine registrations and approvals
...
WITH machine_logs AS (
    SELECT
        ...
        w.working_hours
    FROM {{ ref('work_order_machine_niti_23') }} AS w
    WHERE w.voided != TRUE
)
