...
WITH machine_contractors AS (
    ...
    FROM {{ ref('work_order_machine_niti_23') }} AS wm
...
from
{{ ref('work_order_regn_niti_23') }} as ws
left join
{{ ref('work_order_endline_niti_23') }} as we -- only take the latest instance of work_order_endline - to be coded in later
on
